                    ...
                    <form method="post" action="" id="keycloak-config-form">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="keycloak_realm" name="keycloak_realm"
                                       value="<?php echo htmlspecialchars($keycloakRealm); ?>"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="keycloak_client_id" name="keycloak_client_id"
                                       value="<?php echo htmlspecialchars($keycloakClientId); ?>"
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-success d-block mt-1">
                                    <i class="fa fa-check"></i> <?php echo get_string('client_secret_set', 'local_edulution'); ?>
                                </small>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div id="connection-test-area">
                                <button type="button" class="btn btn-info" id="test-connection-btn"
                                    ...
                                    <i class="fa fa-plug"></i> <?php echo get_string('test_connection', 'local_edulution'); ?>
                                </button>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-success btn-lg">
                                <i class="fa fa-save"></i> <?php echo get_string('save_configuration', 'local_edulution'); ?>
                            </button>
        ...
        <div class="col-lg-4">
                ...
                <div class="card-body">
                    <table class="table table-sm">
                        <tr>
                            ...
                            <td>
                                <?php if ($isConfigured): ?>
                                <span class="badge bg-success"><?php echo get_string('configured', 'local_edulution'); ?></span>
                                <?php else: ?>
                                <span class="badge bg-warning"><?php echo get_string('not_configured', 'local_edulution'); ?></span>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($hasClientSecret): ?>
                                <span class="text-success"><i class="fa fa-check"></i> <?php echo get_string('set', 'local_edulution'); ?></span>
                                <?php else: ?>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="https://www.keycloak.org/documentation" target="_blank" class="btn btn-outline-info btn-sm">
                        <i class="fa fa-external-link"></i> <?php echo get_string('keycloak_documentation', 'local_edulution'); ?>
                    </a>
                </div>
            </div>
        </div>
