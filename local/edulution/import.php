...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <h3>Import Data</h3>
            <p class="text-muted">Upload an edulution export package (.zip) to import data into this Moodle instance.
            </p>
        </div>
    </div>
    ...
    <?php if (!$uploadedfile): ?>
            ...
            <div class="card-body">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Maximum file size:
                            <?php echo local_edulution_format_filesize($maxfilesize); ?></small>
                    </div>
        ...
        <div class="alert alert-info">
            ...
            <pre
                class="mt-2 mb-0">php local/edulution/cli/full_import.php --file=/path/to/export.zip --wwwroot=https://your-site.com</pre>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p><strong>Size:</strong>
                                    <?php echo local_edulution_format_filesize(filesize($uploadedfile)); ?></p>
                            </div>
                            <div class="col-md-6">
                                <?php if ($packageinfo && $packageinfo['manifest']): ?>
                                    <p><strong>Export Type:</strong>
                                        <?php echo htmlspecialchars($packageinfo['manifest']['export_type'] ?? 'Unknown'); ?>
                                    </p>
                                    <p><strong>Export Date:</strong>
                                        <?php echo htmlspecialchars($packageinfo['manifest']['export_timestamp'] ?? 'Unknown'); ?>
                                    </p>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3 text-center mb-3">
                                    <div
                                        class="card <?php echo $packageinfo['has_database'] ? 'border-success' : 'border-secondary'; ?>">
                                        <div class="card-body py-3">
                                            <i
                                                class="fa fa-database fa-2x <?php echo $packageinfo['has_database'] ? 'text-success' : 'text-muted'; ?>"></i>
                                            <p class="mb-0 mt-2"><strong>Database</strong></p>
                                            <span
                                                class="badge <?php echo $packageinfo['has_database'] ? 'bg-success' : 'bg-secondary'; ?>">
                                ...
                                <div class="col-md-3 text-center mb-3">
                                    <div
                                        class="card <?php echo $packageinfo['has_moodledata'] ? 'border-success' : 'border-secondary'; ?>">
                                        <div class="card-body py-3">
                                            <i
                                                class="fa fa-folder fa-2x <?php echo $packageinfo['has_moodledata'] ? 'text-success' : 'text-muted'; ?>"></i>
                                            <p class="mb-0 mt-2"><strong>Moodledata</strong></p>
                                            <span
                                                class="badge <?php echo $packageinfo['has_moodledata'] ? 'bg-success' : 'bg-secondary'; ?>">
                                ...
                                <div class="col-md-3 text-center mb-3">
                                    <div
                                        class="card <?php echo $packageinfo['has_plugins'] ? 'border-success' : 'border-secondary'; ?>">
                                        <div class="card-body py-3">
                                            <i
                                                class="fa fa-plug fa-2x <?php echo $packageinfo['has_plugins'] ? 'text-success' : 'text-muted'; ?>"></i>
                                            <p class="mb-0 mt-2"><strong>Plugins</strong></p>
                                            <span
                                                class="badge <?php echo $packageinfo['has_plugins'] ? 'bg-success' : 'bg-secondary'; ?>">
                                ...
                                <div class="col-md-3 text-center mb-3">
                                    <div
                                        class="card <?php echo $packageinfo['has_manifest'] ? 'border-success' : 'border-warning'; ?>">
                                        <div class="card-body py-3">
                                            <i
                                                class="fa fa-file-text fa-2x <?php echo $packageinfo['has_manifest'] ? 'text-success' : 'text-warning'; ?>"></i>
                                            <p class="mb-0 mt-2"><strong>Manifest</strong></p>
                                            <span
                                                class="badge <?php echo $packageinfo['has_manifest'] ? 'bg-success' : 'bg-warning'; ?>">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-bordered mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($source['release'] ?? $source['version'] ?? 'Unknown'); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <?php if (!empty($packageinfo['manifest']['statistics'])): ?>
                                    ...
                                    <div class="row text-center">
                                        <?php if (isset($stats['database_tables'])): ?>
                                            <div class="col-md-3">
                                                <div class="border rounded p-2">
                                                    <h4 class="text-primary mb-0"><?php echo number_format($stats['database_tables']); ?>
                                                    </h4>
                                            ...
                                            <div class="col-md-3">
                                                <div class="border rounded p-2">
                                                    <h4 class="text-info mb-0">
                                                        <?php echo htmlspecialchars($stats['database_size_formatted']); ?></h4>
                                        ...
                                        <?php if (isset($stats['plugins_additional'])): ?>
                                            <div class="col-md-3">
                                                <div class="border rounded p-2">
                                                    <h4 class="text-warning mb-0"><?php echo number_format($stats['plugins_additional']); ?>
                                                    </h4>
                    ...
                    <?php if ($packageinfo['plugins']): ?>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <p>Comparing <strong><?php echo count($additionalPlugins); ?></strong> additional plugins from
                                    export with your current installation:</p>

                                <?php if (!empty($missing)): ?>
                                    <h6 class="text-danger"><i class="fa fa-exclamation-triangle"></i> Missing Plugins
                                        (<?php echo count($missing); ?>)</h6>
                                    ...
                                    <table class="table table-sm table-bordered mb-4">
                                        ...
                                        <tbody>
                                            ...
                                            <?php if (count($missing) > 10): ?>
                                                <tr>
                                                    <td colspan="3" class="text-muted">... and <?php echo count($missing) - 10; ?> more</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
                                ...
                                <?php if (!empty($different)): ?>
                                    <h6 class="text-warning"><i class="fa fa-refresh"></i> Version Differences
                                        (<?php echo count($different); ?>)</h6>
                                    ...
                                    <table class="table table-sm table-bordered mb-4">
                                        ...
                                        <tbody>
                                            ...
                                            <?php if (count($different) > 10): ?>
                                                <tr>
                                                    <td colspan="3" class="text-muted">... and <?php echo count($different) - 10; ?> more
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                ...
                                <?php if (!empty($same)): ?>
                                    <h6 class="text-success"><i class="fa fa-check"></i> Matching Plugins (<?php echo count($same); ?>)
                                    </h6>
                        ...
                        <div class="card-body">
                            <?php if ($packageinfo['has_database']): ?>
                                <div class="alert alert-warning mb-4">
                                    ...
                                    <p>This package contains a full database dump. Importing will <strong>replace your entire
                                            database</strong>.</p>
                                    <p class="mb-0"><strong>Important:</strong> You will be logged out after import. Log in again
                                        with credentials from the imported database.</p>
                                </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" id="import_database"
                                                    name="import_database" checked>
                                            ...
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" id="import_moodledata"
                                                    name="import_moodledata" <?php echo $packageinfo['has_moodledata'] ? 'checked' : 'disabled'; ?>>
                                                <label class="form-check-label" for="import_moodledata">
                                                    <strong>Import Moodledata</strong>
                                                    <small class="text-muted d-block">Restore uploaded files
                                                        <?php echo !$packageinfo['has_moodledata'] ? '(not in package)' : ''; ?></small>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-check mb-2">
                                                <input class="form-check-input" type="checkbox" id="skip_plugins"
                                                    name="skip_plugins">
                            ...
                            <?php else: ?>
                                <div class="alert alert-info">
                                    ...
                                    <p class="mb-0">This package contains only metadata (plugins list, manifest). It's useful for:
                                    </p>
                                    <ul class="mb-0 mt-2">
