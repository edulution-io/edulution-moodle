...
<div class="setup-wizard">
        ...
        <div class="setup-step">
            ...
            <?php if (!empty($envconfigs)): ?>
                <div class="alert alert-info">
                    ...
                    <strong>Hinweis:</strong> Einige Werte werden über Umgebungsvariablen gesetzt und sind bereits
                    vorausgefüllt.
            ...
            <form method="post" action="">
                ...
                <div class="mb-3">
                    ...
                    <?php else: ?>
                        <input type="url" class="form-control" id="keycloak_url" name="keycloak_url"
                            value="<?php echo s($config['keycloak_url']); ?>" placeholder="https://keycloak.meine-schule.de"
                            required>
                    <?php endif; ?>
                ...
                <div class="mb-3">
                    ...
                    <?php else: ?>
                        <input type="text" class="form-control" id="keycloak_realm" name="keycloak_realm"
                            value="<?php echo s($config['keycloak_realm']); ?>" placeholder="master" required>
                    <?php endif; ?>
                    <small class="form-text text-muted">
                        <?php if (isset($envconfigs['keycloak_realm'])): ?>
                            <i class="fa fa-lock"></i> Gesetzt über:
                            <code><?php echo s($envconfigs['keycloak_realm']); ?></code>
                        <?php else: ?>
                ...
                <div class="mb-3">
                    ...
                    <?php else: ?>
                        <input type="text" class="form-control" id="keycloak_client_id" name="keycloak_client_id"
                            value="<?php echo s($config['keycloak_client_id']); ?>" placeholder="moodle-client" required>
                    <?php endif; ?>
                    <small class="form-text text-muted">
                        <?php if (isset($envconfigs['keycloak_client_id'])): ?>
                            <i class="fa fa-lock"></i> Gesetzt über:
                            <code><?php echo s($envconfigs['keycloak_client_id']); ?></code>
                        <?php else: ?>
                ...
                <div class="mb-3">
                    ...
                    <?php if (isset($envconfigs['keycloak_client_secret'])): ?>
                        <input type="hidden" name="keycloak_client_secret"
                            value="<?php echo s($config['keycloak_client_secret']); ?>">
                        <input type="password" class="form-control bg-light" id="keycloak_client_secret" value="********"
                            disabled>
                    <?php else: ?>
                    ...
                    <small class="form-text text-muted">
                        <?php if (isset($envconfigs['keycloak_client_secret'])): ?>
                            <i class="fa fa-lock"></i> Gesetzt über:
                            <code><?php echo s($envconfigs['keycloak_client_secret']); ?></code>
                        <?php else: ?>
                ...
                <div class="mb-4">
                    <div class="form-check">
                        <?php if (isset($envconfigs['verify_ssl'])): ?>
                            ...
                            <input type="checkbox" class="form-check-input" id="verify_ssl" <?php echo $config['verify_ssl'] ? 'checked' : ''; ?> disabled>
                        <?php else: ?>
                            <input type="checkbox" class="form-check-input" id="verify_ssl" name="verify_ssl" value="1" <?php echo $config['verify_ssl'] ? 'checked' : ''; ?>>
                        <?php endif; ?>
    ...
    <?php if ($step == 2): ?>
        <div class="setup-step">
            ...
            <p class="text-muted">Wählen Sie den Typ Ihrer Schulumgebung. Dies bestimmt, wie Gruppen in Kurse umgewandelt
                werden.</p>
            ...
            <form method="post" action="">
                ...
                <label class="preset-card <?php echo $config['naming_preset'] === 'linuxmuster' ? 'selected' : ''; ?>">
                    <input type="radio" name="preset" value="linuxmuster" <?php echo $config['naming_preset'] === 'linuxmuster' ? 'checked' : ''; ?>>
                    ...
                    <ul class="mt-2 mb-0" style="font-size: 14px; color: #6c757d;">
                        <li><i class="fa fa-users text-primary"></i> <strong>Fachschaften:</strong> p_alle_bio → "Fachschaft
                            Biologie"</li>
                        <li><i class="fa fa-chalkboard-teacher text-primary"></i> <strong>Lehrer-Kurse:</strong>
                            p_mueller_mathe_10a → "Mathematik Klasse 10A (MUELLER)"</li>
                        <li><i class="fa fa-graduation-cap text-primary"></i> <strong>Klassen-Kurse:</strong> p_10a_deutsch
                            → "Deutsch 10A"</li>
                        <li><i class="fa fa-puzzle-piece text-primary"></i> <strong>AGs:</strong> p_robotik_ag → "AG:
                            Robotik"</li>
                    </ul>
                </label>

                <label class="preset-card <?php echo $config['naming_preset'] === 'simple' ? 'selected' : ''; ?>">
                    <input type="radio" name="preset" value="simple" <?php echo $config['naming_preset'] === 'simple' ? 'checked' : ''; ?>>
                ...
                <label class="preset-card <?php echo $config['naming_preset'] === 'custom' ? 'selected' : ''; ?>">
                    <input type="radio" name="preset" value="custom" <?php echo $config['naming_preset'] === 'custom' ? 'checked' : ''; ?>>
    ...
    <?php if ($step == 3): ?>
        <div class="setup-step">
            ...
            <div class="form-help">
                ...
                Alle Kurse, die aus Keycloak-Gruppen erstellt werden, werden in dieser Kategorie (oder Unterkategorien
                davon) angelegt.
            ...
            <form method="post" action="">
                ...
                <div class="mb-4" id="new-category-input"
                    style="<?php echo $config['parent_category_id'] != -1 ? 'display: none;' : ''; ?>">
        ...
        <div class="setup-step text-center">
            ...
            <div class="alert alert-info text-start">
                ...
                <ul class="mb-0 mt-2">
                    ...
                    <li><i class="fa fa-graduation-cap text-primary"></i> Gruppen werden zu Kursen (gemäß Ihrer
                        Einstellungen)</li>
                    <li><i class="fa fa-sign-in text-primary"></i> Benutzer werden automatisch in die passenden Kurse
                        eingeschrieben</li>
                    <li><i class="fa fa-user-secret text-primary"></i> Lehrer erhalten die Rolle "Trainer/in mit
                        Bearbeitungsrechten"</li>
                </ul>
            </div>
