...
if ($hassiteconfig) {
    ...
    $settings->add(new admin_setting_heading(
        'local_edulution/keycloak_heading',
        'Keycloak-Server',
    ...
    $settings->add(new setting_configtext_envaware(
        'local_edulution/keycloak_url',
        'Server-URL',
    ...
    $settings->add(new setting_configtext_envaware(
        'local_edulution/keycloak_realm',
        'Realm',
    ...
    $settings->add(new setting_configtext_envaware(
        'local_edulution/keycloak_client_id',
        'Client-ID',
    ...
    $settings->add(new setting_configpassword_envaware(
        'local_edulution/keycloak_client_secret',
        'Client-Secret',
        'Das geheime Passwort des Clients (unter "Credentials" in den Client-Einstellungen)',
        ''
    ));

    $settings->add(new setting_configcheckbox_envaware(
        'local_edulution/verify_ssl',
    ...
    $settings->add(new setting_configcheckbox_envaware(
        'local_edulution/keycloak_sync_enabled',
    ...
    $syncsettings->add(new admin_setting_configcheckbox(
        'local_edulution/sync_create_users',
    ...
    $syncsettings->add(new admin_setting_configcheckbox(
        'local_edulution/sync_update_users',
    ...
    $syncsettings->add(new admin_setting_heading(
        'local_edulution/sync_danger_heading',
    ...
    $syncsettings->add(new admin_setting_configcheckbox(
        'local_edulution/sync_suspend_users',
    ...
    $syncsettings->add(new admin_setting_configcheckbox(
        'local_edulution/sync_unenroll_users',
    ...
    $syncsettings->add(new admin_setting_configtext(
        'local_edulution/teacher_role_attribute',
        'Rollen-Attribut',
    ...
    $syncsettings->add(new admin_setting_configtext(
        'local_edulution/teacher_role_value',
        'Wert für Lehrer',
    ...
    $categorysettings->add(new admin_setting_heading(
        'local_edulution/category_heading',
    ...
    $categorysettings->add(new admin_setting_configselect(
        'local_edulution/parent_category_id',
    ...
    $categorysettings->add(new admin_setting_configtext(
        'local_edulution/category_name_main',
    ...
    $advancedsettings->add(new admin_setting_heading(
        'local_edulution/advanced_heading',
    ...
    $advancedsettings->add(new admin_setting_configtextarea(
        'local_edulution/naming_schemas',
    ...
    $cookieauthsettings->add(new admin_setting_heading(
        'local_edulution/cookie_auth_heading',
    ...
    $cookieauthsettings->add(new admin_setting_configcheckbox(
        'local_edulution/cookie_auth_enabled',
    ...
    $cookieauthsettings->add(new admin_setting_configtext(
        'local_edulution/cookie_auth_cookie_name',
        'Cookie-Name',
    ...
    $cookieauthsettings->add(new admin_setting_configtext(
        'local_edulution/cookie_auth_user_claim',
        'Benutzer-Claim',
    ...
    $cookieauthsettings->add(new admin_setting_heading(
        'local_edulution/cookie_auth_key_heading',
        'Token-Verifizierung',
    ...
    $cookieauthsettings->add(new admin_setting_configtext(
        'local_edulution/cookie_auth_realm_url',
        'Realm-URL (optional)',
    ...
    $cookieauthsettings->add(new admin_setting_configtextarea(
        'local_edulution/cookie_auth_public_key',
        'Public Key (optional)',
    ...
    $cookieauthsettings->add(new admin_setting_configselect(
        'local_edulution/cookie_auth_algorithm',
        'Algorithmus',
    ...
    $cookieauthsettings->add(new admin_setting_configtext(
        'local_edulution/cookie_auth_issuer',
        'Issuer (optional)',
    ...
    $cookieauthsettings->add(new admin_setting_configcheckbox(
        'local_edulution/cookie_auth_fallback_email',
        'E-Mail-Fallback',
    ...
    $cookieauthsettings->add(new admin_setting_configcheckbox(
        'local_edulution/cookie_auth_debug',
        'Debug-Modus',
    ...
    $cookieauthsettings->add(new admin_setting_heading(
        'local_edulution/cookie_auth_test_heading',
        'Testen',
