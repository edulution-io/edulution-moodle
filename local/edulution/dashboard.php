    ...
    <?php elseif (!$connectionstatus || !$connectionstatus['success']): ?>
        <div class="status-card danger">
            ...
            <div class="status-content">
                ...
                <div class="status-detail"><?php echo s($connectionstatus['message'] ?? 'Keine Verbindung zu Keycloak'); ?>
                </div>
            </div>
            ...
            <div id="sync-progress-container" style="display: none;" class="mt-4">
                ...
                <div class="progress" style="height: 25px;">
                    <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar"
                        style="width: 0%;" id="sync-progress-bar">0%</div>
                </div>
            </div>
                ...
                <div class="last-sync-info">
                    ...
                    <div class="d-flex flex-wrap gap-3">
                        <?php if (isset($lastsyncstats['users_created'])): ?>
                            <span><i class="fa fa-user-plus text-muted"></i> <?php echo $lastsyncstats['users_created']; ?>
                                Benutzer</span>
                        <?php endif; ?>
                        <?php if (isset($lastsyncstats['courses_created'])): ?>
                            <span><i class="fa fa-plus-circle text-muted"></i> <?php echo $lastsyncstats['courses_created']; ?>
                                Kurse</span>
                        <?php endif; ?>
                        <?php if (isset($lastsyncstats['enrollments_created'])): ?>
                            <span><i class="fa fa-sign-in text-muted"></i> <?php echo $lastsyncstats['enrollments_created']; ?>
                                Einschreibungen</span>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endif; ?>
        ...
        <div class="sync-section">
            ...
            <table class="table table-sm config-table mb-0">
                <tr>
                    ...
                    <td><code><?php echo s($keycloakurl); ?></code><?php if (isset($envconfigs['keycloak_url'])): ?> <span
                                class="badge bg-secondary">ENV</span><?php endif; ?></td>
                </tr>
                <tr>
                    <td><i class="fa fa-database"></i> Realm</td>
                    <td><code><?php echo s($keycloakrealm); ?></code><?php if (isset($envconfigs['keycloak_realm'])): ?>
                            <span class="badge bg-secondary">ENV</span><?php endif; ?></td>
                </tr>
                <tr>
                    <td><i class="fa fa-id-card"></i> Client</td>
                    <td><code><?php echo s($keycloakclientid); ?></code><?php if (isset($envconfigs['keycloak_client_id'])): ?>
                            <span class="badge bg-secondary">ENV</span><?php endif; ?></td>
                </tr>
                <tr>
                    <td><i class="fa fa-refresh"></i> Auto-Sync</td>
                    <td><?php echo $syncenabled ? '<i class="fa fa-check text-success"></i> An' : '<i class="fa fa-times text-muted"></i> Aus'; ?>
                    </td>
                </tr>
            </table>
        </div>
